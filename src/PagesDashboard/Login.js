                                    ...
                                    <div>
                                        <div className="mt-3 text-left sm:mt-5">
                                            ...
                                            <div className="mt-4 text-base text-gray-500">
                                                <p>Nakoa Cafe : Best Coffee Made For You</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form onSubmit={this.handleLogin}>
                                        <div className="mt-6 space-y-2">
                                            ...
                                            <div className="flex flex-col mt-4 lg:space-y-2">
                                                <button type="submit" name="login" className="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-red-600 rounded-xl hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Log In</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div className="order-first hidden w-full lg:block">
                                    <img className="object-cover h-full bg-cover rounded-l-lg" src="../assets/nakoa.jpg" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
