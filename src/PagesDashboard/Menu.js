...
export default class Menu extends React.Component {
    ...
    handleDrop = (id) => {
        ...
        if (window.confirm("Are tou sure to delete this menu ? ")) {
            ...
            <div class="flex flex-row min-h-screen bg-gray-100 text-gray-800">
                ...
                <main class="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
                    ...
                    <div class="main-content flex flex-col flex-grow p-4">
                        <h1 class="font-bold text-xl text-black-700">Daftar Menu</h1>
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <div class="CardEvent" key={index}>
                                            <div class="max-w-sm rounded overflow-hidden shadow-lg border-2 border-gray-200 bg-gray-100">
                                                ...
                                                <div class="px-6 py-4">
                                                    <div class="font-bold text-2xl mb-2"> {item.nama_menu}</div>
                                                    <p class="text-gray-1000 text-base">
                                                        <LinesEllipsis
                                                            text={item.deskripsi}
                                                            maxLine="3"
                                                            ellipsis="..." />
                                                    </p>
                                                    <div class="text-gray-700 text-base text-black-600">Harga : {item.harga}</div>
                                                    <div class="text-gray-700 text-base text-black-600">Jenis : {item.jenis}</div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="flex lg:h-auto w-auto justify-center ">
                        <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-black">Menu</h3>
                                <form class="space-y-6" onSubmit={(event) => this.handleSave(event)}>
                                    <div>
                                        ...
                                        <input type="text" name="nama_menu" id="nama_menu" value={this.state.nama_menu} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan nama menu" required />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <textarea rows="3" type="text" name="deskripsi" id="deskripsi" value={this.state.deskripsi} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan deskripsi" />
                                    </div>
                                    <div>
                                    ...
                                    <button type="submit" class="w-full text-white bg-gradient-to-br from-red-600 to-red-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Simpan</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                {/* <div id="modal_detail" tabindex="-1" class="overflow-x-auto fixed top-0 left-0 right-0 z-50 hidden w-full pt-10 pb-10 pl-96 md:inset-0 h-modal md:h-full bg-tranparent bg-black bg-opacity-50" >
                    <div class="relative w-full h-full max-w-lg md:h-auto border-2 border-gray-500 rounded-lg shadow shadow-2xl items-center">
                        <div class="relative bg-white rounded-lg">
                            ...
                            <div class="p-6">
                                <div className='container'>
                                    <img class="rounded-md w-200 h-100" src={"http://localhost:8080/uploads/image/" + this.state.gambar} />
                                </div>
                                <div class="px-2 py-4">
                                    <div class="font-bold text-2xl mb-2">{this.state.nama_menu}</div>
