...
export default class HitoryTransaksi extends React.Component {
  ...
  _handleFilter = () => {
    let data = {
      ...
      tgl_transaksi: this.state.keyword
    };
          ...
          <div class="main-content flex flex-col flex-grow p-4">
            ...
            <div className="flex mt-2 flex-row-reverse mr-4">
              <div className="flex rounded w-1/2">
                <input
                  type="text"
                  className="w-2/3 block w-full px-4 py-2 bg-white border rounded-md focus:border-red-400 focus:ring-red-300 focus:outline-none focus:ring focus:ring-opacity-40"
                  placeholder="Search..."
                  name="keyword"
                  value={this.state.keyword}
                  onChange={this.handleChange}
                />
                <button className="w-1/8 ml-2 px-4 text-white bg-red-100 border border-1 border-red-600 rounded hover:bg-red-200" onClick={this._handleFilter}>
                  <FontAwesomeIcon icon={faSearch} color="red" />
                </button>
                {this.state.role === "kasir" &&
                  <button className="w-1/3 ml-2 px-4 text-white bg-red-600 rounded hover:bg-red-700" onClick={() => this.handleAdd()}>
              ...
              <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" onSubmit={(event) => this.handleAddTransaksi(event)}>
                  <div>
                    ...
                    <input type="text" name="nama_pelanggan" id="nama_pelanggan" onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan nama pelanggan" required />
                  </div>
                  <div>
                    <label for="id_meja" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">id meja</label>
                    <input type="text" name="id_meja" id="id_meja" onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan id meja" required />
                  </div>
                  <div>
                    <label for="id_user" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">id user</label>
                    <input type="text" name="id_user" id="id_user" onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan id user" required />
                  </div>
                  <div>
                    <label for="id_menu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">id menu</label>
                    <input type="text" name="id_menu" id="id_menu" onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan id menu" required />
                  </div>
                  <div>
                    <label for="meja" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">nomor meja</label>
                    <input type="text" name="meja" id="meja" onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan nomor meja" required />
                  </div>
                  <div>
                    <label for="nama_user" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">nama user</label>
                    <input type="text" name="nama_user" id="nama_user" onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan nama user" required />
                  </div>
                  <div>
                  ...
                  <button type="submit" class="w-full text-white bg-gradient-to-br from-red-600 to-red-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                    Simpan
                  </button>
                </form>
              </div>
              ...
              <div class="px-6 py-6 lg:px-8">
                ...
                >
                  <div>
                    ...
                    <select
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-black"
                  ...
                  <button
                    type="submit"
                    class="w-full text-white bg-gradient-to-br from-red-600 to-red-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                  >
                    Simpan
                  </button>
                </form>
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      onChange={this.handleChange}
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800"
                  ...
                  <button
                    type="submit"
                    className="w-full text-white bg-gradient-to-br from-purple-600 to-red-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                  >
                    Simpan
                  </button>
                </form>
